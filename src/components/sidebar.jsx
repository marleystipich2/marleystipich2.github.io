        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/portfolio_pic.PNG)'}} />
              <h1 id="colorlib-logo"><a href="index.html">Marley Sorine (Stipich)</a></h1>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                <li><a href="https://www.linkedin.com/in/marley-sorine-84712b150/" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
